...
export class ProfileComponent {
  ...
  signContract(){
    this.UI.createMessage({
      ...
      text:'Contract signature for position: '+((this.focusUserLastMessageObj.contract||{}).position||null)+', level: '+((this.focusUserLastMessageObj.contract||{}).level||0)+', availability: '+((this.focusUserLastMessageObj.contract||{}).availability||0),
      contractSignature:{
