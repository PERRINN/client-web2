  ...
  template: `
    ...
    <div>
      <div *ngIf="UI.currentUser" style="max-width:800px;margin:0 auto">
        ...
        <img *ngIf="UI.currentUserLastMessageObj?.PERRINN?.wallet?.balance>0" class='editButton' style="float:right;width:20px;filter:grayscale(100%)" src="./../assets/App icons/onshapeLogo.png" onclick="window.open('https://cad.onshape.com/documents?nodeId=31475a51a48fbcc9cfc7e244&resourceType=folder','_blank')">
        <img *ngIf="UI.currentUserLastMessageObj?.PERRINN?.wallet?.balance>0" class='editButton' style="float:right;width:20px;filter:grayscale(100%)" src="./../assets/App icons/Google_Drive_icon_(2020).svg" onclick="window.open('https://drive.google.com/drive/u/1/folders/1qvipN1gs1QS4sCh1tY8rSSFXV5S0-uR3','_blank')">
        <img *ngIf="UI.currentUserLastMessageObj?.PERRINN?.wallet?.balance>0" class='editButton' style="float:right;width:20px;margin-top:6px;filter:grayscale(100%)" src="./../assets/App icons/google-meet-logo.png" onclick="window.open('https://meet.google.com/rxn-vtfa-shq','_blank')">
      </div>
