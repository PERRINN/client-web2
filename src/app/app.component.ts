...
@Component({
  ...
  template: `
    ...
    <div style="width:320px;display:block;margin: 0 auto">
      ...
      <img src="./../assets/App icons/book.jpg" style="cursor:pointer;float:left;width:30px;margin:5px 5px 5px 45px;border-radius:3px;filter: brightness(0) invert(1)" onclick="window.open('https://sites.google.com/view/perrinn/home', '_blank')">
    </div>
    </div>
