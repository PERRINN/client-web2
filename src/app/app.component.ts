  ...
  template: `
    ...
    <div class='menu'>
      <div style="width:320px;display:block;margin: 0 auto">
        <img src="./../assets/App icons/Perrinn_02.png" style="cursor:pointer;float:left;width:30px;margin:5px 45px 5px 5px;border-radius:3px;" (click)="router.navigate(['profile','user',UI.currentUser])">
    ...
    <div style='padding-top:40px'>
      <div *ngIf="UI.currentUser" style="max-width:800px;margin:0 auto">
        ...
        <div style="float:left;width:150px;height:33px;cursor:pointer;border-style:solid;border-width:0 1px 0 0;border-color:#ddd" (click)="router.navigate(['profile','domain',UI.currentDomain])">
          ...
          <div *ngIf="UI.currentDomainLastMessageObj?.domain" style="float:left;margin:5px;font-size:10px">{{UI.currentDomainLastMessageObj.domain}}</div>
        </div>
